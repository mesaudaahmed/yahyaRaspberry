...
class Ui_insertWindow(object):
    ...
    def retranslateUi(self, insertWindow):
        ...
        self.lineEdit_3.setPlaceholderText(_translate("insertWindow", "Reload time en minute"))
        self.lineEdit_2.setPlaceholderText(_translate("insertWindow", "Tag id"))
        ...
        self.lineEdit.setPlaceholderText(_translate("insertWindow", "esp"))
        ...
        self.pushButton.setText(_translate("insertWindow", "Perform"))
        self.label_10.setText(_translate("insertWindow", "max=360"))
